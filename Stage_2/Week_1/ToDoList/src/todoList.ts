...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (clearCompletedBtn) clearCompletedBtn.addEventListener("click", clearCompletedItems);
});
function renumberTaskList() {
    const tbody = document.getElementById("taskList") as HTMLTableSectionElement | null;
    if (!tbody) return;
...
function addItem() {
    ...
    const tbody = document.getElementById("taskList") as HTMLTableElement | null;
...
function removeItem() {
    var inputTaskToRemove = document.getElementById("item") as HTMLInputElement | null;
...
function clearItemsInList() {
    const clearItems = document.getElementById("taskList") as HTMLTableElement;
...
function markItemComplete() {
    ...
    const tableComplete = document.getElementById("completedList") as HTMLTableElement;
...
function clearCompletedItems() {
    const clearItems = document.getElementById("completedList") as HTMLTableElement;
    const inputElement = document.getElementById("item") as HTMLInputElement;
    if (clearItems === null || clearItems.rows.length === 0) {
        alert("Sorry: There is nothing to clear.")
        return;
